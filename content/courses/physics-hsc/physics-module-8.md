...
- The extremely high temperature and pressure produced by gravity in the core of stars enables them to convert matter to energy through fusion reactions. These reactions result in the conversion of mass to energy in accordance with Einstein’s mass-energy equivalence E=mc2
...
Ø EM radiation is emitted as excited electrons fall back to lower energy levels and produce emission lines, which represent the energy values of the particular electron transfers for that element
...
Ø Atoms absorb photons of specific energies. The atom absorbing the photon could be initially in the neutral ground state or it could be in an excited state. The energy values absorbed are represented by the black lines 
...
Ø Stars are classified into 7 spectral classes labelled OBAFGKM, where O stars are the hottest

Ø The system is subdivided further using numbers from 0-9, where 9 represents the coolest star
...
Involves 3 reactions that enable 4 protons to fuse to helium in the core of MS stars around the mass of the Sun or less
...
A cyclic process involving carbon isotopes being changed to nitrogen and oxygen and back to carbon in a catalytical process that enables 4 protons to fuse to helium in the cores of much larger and hotter stars (>1.3 solar masses)

- Each time the cycle is repeated, 4 protons (  ) are converted to a helium nuclei (  ) plus 3 gamma rays (  ), 2 positrons (  ), and 2 electron neutrinos (  )
...
- A carbon-12 nucleus captures a [proton](http://astronomy.swin.edu.au/cosmos/P/Proton) and emits a gamma ray, producing nitrogen-13.
...
- He measured the radius of curvature of the rays in a mag field and found the charge-to-mass ratio of the particles
...
- After Thomson found the charge-to-mass ratio of the electron, there were still 2 unknowns; the mass and charge

- if the electron was a quantum of charge, Millikan figured an ionised object would have a charge that would be an integer multiple of the charge on the electron. To find the charge, he used an electric field to levitate droplets of known mass

- when the charge is at rest, the forces must sum to 0,

 

 

- ‘m’ is mass of sphere; d is separation b/w charged plates
...
- He proposed the electrostatic attraction b/w -ve electrons and +ve nucleus would provide centripetal force to hold the electrons in orbit
...
## 8.3 Quantum Mechanical Nature of the Atom
...
v Unstable model since orbiting electrons would emit EM radiation, lose energy, and spiral into nucleus

v Couldn’t explain atomic emission and absorption spectra
...
v Electrons can only orbit in specific quantised orbits, which he called stationary states. They did not emit EM radiation

v An electron can move b/w orbitals by emitting or absorbing a photon of radiation with an energy equal to the energy difference b/w orbitals

 

v The orbitals can only have an angular momentum given by:
...
- He overcame Rutherford’s limitations by:

v His 1st postulate overcomes Rutherford’s stability problem

v His 2nd postulate explains atomic emission and absorption spectra by saying each line in the spectra corresponds to specific photon energy related to an electron moving b/w orbitals. Photons are absorbed when electron moves to higher level, and photons emitted when moving to lower level

- Limitations of Bohr’s model

v Not possible to calculate wavelengths of spectral lines of all other atoms

v Works well for atoms with one electron in outer shell but not for others

v Couldn’t explain the Zeeman effector the hyperfine splitting of spectral lines

v His model is a mixture of classical and quantum physics, ignored laws of electromagnetism

 

- Rydberg’s equation

v Generalised Balmer’s equation and could calculate wavelength of the photon emitted or absorbed for any transition of an electron
...
- generated a mathematical model for the distribution of electrons in an atom

v electron cloud model – probability of electron’s location around nucleus
...
v highly ionising but not very penetrating. Can be stopped by few sheets of paper or few cm of air

 

X is symbol for element

Z is atomic number (no.protons)

A is mass number (no. nucleons)

v both sides of equation should be balanced 

Beta decay

v High-speed electrons

v Less ionising than alpha, but more penetrating

v  Always accompanied by antineutrino ( 

 

Beta-minus decay above, for beta-plus (Z-1) and   and neutrino  

 

Gamma decay

v High frequency photons, hence no charge

v Poor ionisers but very penetrating

v Stopped by 5cm of lead
...
Ø Changing the one chemical element into another by artificial methods
...
Ø Neutron moderation: using material containing small nuclei that doesn’t absorb neutrons – slows neutrons down

Ø Critical mass: minimum mass required to sustain a fission chain reaction in a solid sphere of fissionable material 
...
- Calculate mass defect – difference in mass b/w the nucleons and the atom (e.g.   )

Ø mass of nucleons = 4.0026 u

Ø mass of helium atom = 4.0331 u 

Ø mass defect = 4.0331 u – 4.0026 u = 0.0305 u 

- Calculate the nuclear binding energy using E=mc2 (1 amu = 1.6605 x 10-27 kg)
...
| Control  rods | These  are boron or cadmium rods that absorb neutrons. These rods are lowered into  the reactor to control the rate of reaction |
...
- Nucleons are held in the nucleus by the strong nuclear force, which acts b/w all nucleons and is significantly stronger than the electrostatic force, which tries to push protons apart in the nucleus
...
- Requires some energy to start the process since electrostatic repulsion b/w nuclei must be overcome to bring them close enough together for the strong nuclear force to bind the nucleons together 
...
Ø Rutherford fired alpha particles into nitrogen gas and detected a highly energetic particle that he identified to be a proton 
...
Ø Find the mass defect

Ø Then use Einstein’s equation to determine the mass released in joules

Ø Alternatively; if masses are given in atomic mass units (amu), multiply the mass defect by 931.5 MeV to obtain the energy released in MeV

## 8.5 Deep Inside the Atom
...
Ø Quarks are elementary particles that are the building blocks of hadrons; have a fractional charge, interact with strong force, obey Pauli exclusion principle

- Evidence that protons & neutrons were not fundamental particles:

Ø Beta-minus decay involved a neutron being transformed into a proton and beta-plus decay involved a proton changing into a neutron. Since electrons/positrons were emitted, these changes indicated an internal structure 

Ø Measurements of the magnetic moment of nuclei showed that the neutron had an associated magnetic field, suggesting that some moving charge(s) existed within the neutron 

Ø Inelastic scattering experiments b/w electrons and protons in 1969, conducted using high-energy particle accelerators, indicated there were tiny, scattering centres inside protons 
...
Ø Large subatomic particles called hadrons to distinguish them from leptons (electrons and neutrinos)

Ø Hadrons: heavy composite particles made up of quarks that are affected by the strong nuclear force 

Ø Leptons: elementary particles that aren’t affected by the strong nuclear force 
...
- EM force acts b/w charged particles – electrostatic force b/w nucleons. It has an infinite range, but is much stronger. The particle responsible for this force is the photon
...
- The strong nuclear force acts at a very short distance b/w nucleons that holds them together in the nucleus 
...
| Strong nuclear | b/w quarks & b/w nucleons | 1                 | Pions (b/w nucleons)  Gluons (b/w quarks) | 10-15     |
...
v all observed matter in the Universe is made up from elementary particles – 6 quarks, 6 leptons, & 5 types of bosons 
...
Ø Proton – 2 up and 1 down quarks 

Ø Neutron – 2 down and 1 up quarks 
...
- The theory that describes the elementary particles of nature and 3 of the forces (excluding gravity) that operate b/w them
...
Ø Meson: a hadron made up of 2 quarks (a quark-antiquark pair)

Ø Baryon: a hadron made up of 3 quarks with different colour charges 
...
- Charged particles travel in an evacuated space b/w 2 dees (d-shaped magnets) which forces them to travel in a circle
...
- Relatively cheap and cannot be used to accelerate large particles 
...
- Inside the tubes, although charged, the net electric field is 0, so they only accelerate across the gaps b/w the tubes 

- Easier to construct than others, less expensive, do not need mag fields or large diameter for construction 
...
- Uses a mag field to keep accelerating particles moving in a circle of constant radius
