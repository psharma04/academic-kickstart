...
- Fajan’s method relies on a large precipitate surface area, to allow sufficient dye to adsorb so the colour change is easily visible.
...
7. The hollow cathode lamp contains the element which being tested. It emits a certain spectral pattern – unique to each metal.
