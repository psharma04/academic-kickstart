...
10. $\frac{d}{dx}af(x)=a(f\prime (x))$ {{% alert note %}}
    \(\frac{d}{dx} \Leftarrow\Rightarrow\) differentiate with respect to $x$ \(\frac{dy}{dx} \Leftarrow\Rightarrow\frac{d}{dx}(y)\Leftarrow\Rightarrow y\prime\Leftarrow\Rightarrow\) differentiate $y$ with respect to $x$ {{% /alert %}}
