...
* \\(ln(x)=\frac{1}{\ln(x)}\cdot \frac{1}{x}\Graphs
...
7. factorise numerator to eliminate h
   ...
   > \\(=\frac{\cancel{h}(4x^3 +6x^2 h +4xh^2 +h^3 +5)}{\cancel{h}}\\) \\(=4x^3 +6x^2 h +4xh^2 +h^3 +5)
8. Substitute \\(h=0\\)
...
1. $\frac{d}{dx}(a) = 0$
>>>>>>> 60b01e1cfc41aed1bf9f268e768989d2e2133b2b
2. $\frac{d}{dx}ax=a$
...
{{% alert note %}}
\\(\frac{d}{dx} \Leftarrow\Rightarrow\\) differentiate with respect to $x$ \\(\frac{dy}{dx} \Leftarrow\Rightarrow\frac{d}{dx}(y)\Leftarrow\Rightarrow y\prime\Leftarrow\Rightarrow\\) differentiate $y$ with respect to $x$
{{% /alert %}}
...
| \\(f(x)\\)                        | \\(\frac{d}{dx}(f(x))\\)       |
| ------------------------------- | ---------------------------- |
| Turning Points/Standing P| Points of Inflection            | Turning Points               |
