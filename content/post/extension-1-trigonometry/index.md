...
> $t=tan(\frac{A}{2})$
  ...
  > \- {{% mention jackson-taylor %}}
- $sin A=\frac{2t}{1+t^2}$
![Proof for sine](https://cdn.schoolnotes.xyz/images/png/sin-t-formula-proof.png)
- $cos A=\frac{1-t^2}{1+t^2}$
![Proof for cosine](https://cdn.schoolnotes.xyz/images/png/cos-t-formula-proof.png)
- $tan A=\frac{2t}{1-t^2}$
![Proof for tangent](https://cdn.schoolnotes.xyz/images/png/tan-t-formula-proof.png)
